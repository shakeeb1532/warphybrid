...
**Benchmark Script**: [`test_warp_hybrid.py`](test_warp_hybrid.py)
...
2. Install `lz4` via [vcpkg](https://github.com/microsoft/vcpkg).
3. Ensure `/openmp` is enabled in the compiler options (set in `setup.py`).
...
- **LZ4** – High-speed compression algorithm ([lz4.github.io/lz4](https://lz4.github.io/lz4/))
